...
import Page1 from "../../../../public/photos/books/AyannaTheMakanga/page1.jpg";
  ...
  return (
    <div className={styles.coverContainer}>
      ...
      <div className={styles.buttonsContainer0}>
        ...
        <div className={styles.pageButton0}>
          <Button variant="normal" text="Open Page 1" action={()=> router.push("/soma/ayanna-the-makanga/page1")}></Button>
        </div>
      </div>
      <div className={styles.page0ContentContainer}>
        <motion.div 
          ...
          animate={["center"]}
        >
          <Image src={Page1} width={420} height={460} alt="Ayanna the makanga" priority/>
        </motion.div>
        <motion.div 
          ...
          animate={["center"]}          
        >
          {ayannaTheMakanga.pagesData[0].paragraph}
        </motion.div>
      </div>
    </div>
  );
...
export default AyannaTheMakanga;
