...
import page1Image from "../../../../public/photos/books/JebetTheRunner/1.jpg";
  ...
  return (
    <div className={styles.page1Container}>
      <div className={styles.page1ContentContainer}>
        ...
        >
          <Image src={page1Image} width={420} height={540} alt="Jebet the runner" priority/>
        </motion.div>
        <motion.div 
      ...
      <div className={styles.buttonsContainer}>
        ...
        <Button variant="normal" text="Previous Page" action={()=> router.push("/soma/jebet-the-runner/")}></Button>
        <Button variant="normal" text="Next Page" action={()=> router.push("/soma/jebet-the-runner/page2")}></Button>
      </div>
    </div>
  )
}
