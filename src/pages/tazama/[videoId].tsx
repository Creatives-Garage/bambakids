...
export default function VideoName({ videos }: any) {
  ...
  const video = videoData?.find((video: any) => video?.videoId === videoId);
      ...
      <div className={styles.pageContainer}>
        ...
        <div className={styles.videoPlayerWrapper}>
          ...
          <div className={styles.rightSideWrapper}>
            <div className={styles.titleContainer}>MORE LIKE THIS</div>
                  ...
                  <div key={index}>
                    <Link href={`/tazama/${item.videoId}`}>
                      <div className={styles.suggestedVideo}>
                        ...
                        <div className={styles.suggestedVideoTitle}>
                          {item.videoName}
                        </div>
                      </div>
                    </Link>
